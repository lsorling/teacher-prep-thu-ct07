...
function draw() {
    ...
    if (startGame) {
        ...
        if (bird.collides(pipeGroup) || bird.collides(floor)) {
            ...
            // slide got error, without this line, the gameoverLabel collides with the bird, and showed as rotated message
            ...
            setTimeout(() => {
                ...
                startGame = false;
                score = 0;
                scoreGroup.removeAll(); // otherwise i still see the score
